...
Current module cite the code written by Colin Quirk (cquirk@uchicago.edu) and Jonathan van Leeuwen  (j.vanleeuwen@vu.nl)

Rewrite by Baiwei Liu (lbwair@icloud.com)
"""
import os
import sys
import time
